...
* Updated: George Downing 2024 (mac support)
*
...
const char *comports[RS232_PORTNR]={"/dev/tty.usbserial-110","/dev/ttyS1","/dev/ttyS2","/dev/ttyS3","/dev/ttyS4","/dev/ttyS5",
