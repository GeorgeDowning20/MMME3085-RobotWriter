\begin{titlepage}
    \centering
    %\vspace*{0.5 cm}
    \includegraphics[scale = 0.4]{Config/uon.png}\\[2 cm]	% University Logo

    
    \textsc{\Large Department of Mechanical, Materials and Manufacturing Engineering}\\[0.3 cm]	% University Name
    \textsc{\large Computer Engineering and Mechatronics }\\[0.3 cm]				% Course Code
    \textsc{\large (MMME3085 UNUK) (AUT1 24-25)}\\[3 cm]				% Course Name
...
%     \textsc{\textbf{\large{Abbreviations:}}}\\[0.3 cm]
%     \normalsize
...
% \textbf{TEK} - Total Energy Kompensation, 
% \textbf{ASI} - Airspeed Indicator, 
% \textbf{AoA} - Angle of Attack, 
% \textbf{TRL} - Technology Readiness Level, 
% \textbf{NMEA} - National Marine Electronics Association, 
% \textbf{RASP} - Regional Atmospheric Soaring Prediction, 
